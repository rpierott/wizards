...
private:
	...
	// my declarations
	static int luaPlayerGetSkillPoints(lua_State *L); //@Skill points system
	static int luaPlayerAddSkillPoints(lua_State *L); //@Skill points system
	static int luaPlayerSetSkillLevel(lua_State *L); //@Skill points system
	static int luaPlayerAddSkill(lua_State *L); //@Skill points system
	static int luaPlayerRefreshSkills(lua_State *L); //@Skill points system
