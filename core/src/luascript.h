...
private:
	...
	static int luaItemSetSoulbound(lua_State *L); //@Soulbound system
	static int luaItemIsSoulbound(lua_State *L);  //@Soulbound system
	...
	static int luaItemTypeIsSoulbound(lua_State *L); //@Soulbound system
