...
enum AttrTypes_t
{
	...
	// My attributes
	ATTR_SOULBOUND = 42, //@Soulbound system
};
...
public:
	...
	void setSoulbound(bool soulbound)
	{
		setIntAttr(ITEM_ATTRIBUTE_SOULBOUND, static_cast<int64_t>(soulbound));
	} //@Soulbound system
	...
	{
		if (hasAttribute(ITEM_ATTRIBUTE_SOULBOUND))
		{
			return getIntAttr(ITEM_ATTRIBUTE_SOULBOUND) == 1;
		}
		return items[id].soulbound;
	} //@Soulbound system
