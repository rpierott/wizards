...
void LuaScriptInterface::registerFunctions()
{
																																																																																																																																																																																																																																																																																																																																																																																																						...
																																																																																																																																																																																																																																																																																																																																																																																																						registerEnum(ITEM_ATTRIBUTE_DECAYTO)
																																																																																																																																																																																																																																																																																																																																																																																																							registerEnum(ITEM_ATTRIBUTE_WRAPID)
																																																																																																																																																																																																																																																																																																																																																																																																								registerEnum(ITEM_ATTRIBUTE_STOREITEM)
																																																																																																																																																																																																																																																																																																																																																																																																									registerEnum(ITEM_ATTRIBUTE_SOULBOUND) //@Soulbound system
	...
	registerMethod("Item", "setSoulbound", LuaScriptInterface::luaItemSetSoulbound); //@Soulbound system
	registerMethod("Item", "isSoulbound", LuaScriptInterface::luaItemIsSoulbound);	 //@Soulbound system
	...
	registerMethod("ItemType", "isSoulbound", LuaScriptInterface::luaItemTypeIsSoulbound); //@Soulbound system
...
int LuaScriptInterface::luaItemSetSoulbound(lua_State *L)
{
	// item:setSoulbound(soulbound)
	Item *item = getUserdata<Item>(L, 1);
	if (!item)
	{
		lua_pushnil(L);
	...
	item->setSoulbound(getBoolean(L, 2, false));
	return 1;
} //@Soulbound system
...
int LuaScriptInterface::luaItemIsSoulbound(lua_State *L)
{
	// item:isSoulbound()
	Item *item = getUserdata<Item>(L, 1);
	if (item)
	{
		pushBoolean(L, item->isSoulbound());
	}
	else
	{
		lua_pushnil(L);
...
int LuaScriptInterface::luaItemTypeIsSoulbound(lua_State *L)
{
	// itemType:isSoulbound()
	const ItemType *itemType = getUserdata<const ItemType>(L, 1);
	if (itemType)
	{
		pushBoolean(L, itemType->soulbound);
	}
	else
	{
		lua_pushnil(L);
