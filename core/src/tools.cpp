...
itemAttrTypes stringToItemAttribute(const std::string &str)
{
	...
	else if (str == "soulbound")
	{
		return ITEM_ATTRIBUTE_SOULBOUND;
	} //@Soulbound system
...
const char *getReturnMessage(ReturnValue value)
{
	...
	case RETURNVALUE_CANNOTDROPSOULBOUND:					//@Soulbound system
		return "You cannot trade or drop soulbound items."; //@Soulbound system
